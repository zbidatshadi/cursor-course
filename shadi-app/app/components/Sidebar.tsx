...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-zinc-200 flex flex-col h-screen sticky top-0 z-10">
      {/* Logo */}
      ...
      <nav className="flex-1 px-4 py-6">
        <ul className="space-y-1">
          ...
          <li>
            <a
              href="#"
              className="flex items-center gap-3 px-3 py-2 rounded-lg text-zinc-600 hover:bg-zinc-50 transition-colors text-sm"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
