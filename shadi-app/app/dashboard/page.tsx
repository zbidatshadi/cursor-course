            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    aria-label="GitHub"
                    className="text-zinc-400 hover:text-zinc-600 transition-colors p-2 hover:bg-zinc-100 rounded-lg"
                  >
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-zinc-200">
                  ...
                  <div className="flex flex-col">
                    ...
                    <button
                      ...
                      className="text-xs text-zinc-500 hover:text-zinc-700 text-left transition-colors"
                    >
                      Sign out
                    </button>
                  </div>
